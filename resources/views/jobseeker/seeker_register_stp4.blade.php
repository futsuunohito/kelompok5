                ...
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="panel-body" id="works">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalCompany">+ ADD COMPANY/POSITION</button>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="panel-body" id="skill">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalSkills">+ ADD SKILLS</button>
