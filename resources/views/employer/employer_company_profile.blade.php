                        ...
                        <div class="form-horizontal" id="company_form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="country" id="country" class="form-control">
                                        ...
                                        <option value="Fmipa"@if($company->country == "fmipa"){{'selected="selected"'}}@endif>Fakultas Matematika dan Ilmu Pengetahuan Alam</option>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" class="btn btn-warning form-control" style="text-transform: uppercase;border-radius:0;">Save Changes</button>
                                    <!-- <input class="btn btn-warning" id="save" style="border-radius: 0;" value="SAVE CHANGES"> -->
