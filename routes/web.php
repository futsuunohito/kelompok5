...
|
*/
Route::get('/welcome', 'AdminController@welcome')->name('welcome.page');
...
Route::group(['middleware'=>['auth','seeker']], function(){
	...
	Route::post('seeker/activity', 'SeekerController@storeActivityProfile')->name('seeker.activity');
...
Route::get('admin/test', 'SeekerController@test')->name('admin.test');